...
export const DisplacementSphere = props => {
  ...
  useEffect(() => {
    ...
    startTransition(() => {
      geometry.current = new SphereGeometry(30, 100, 150);
  ...
  useEffect(() => {
    const dirLight = new DirectionalLight(0xffffff, theme === 'light' ? 2.8 : 1.0);
    const ambientLight = new AmbientLight(0xffffff, theme === 'light' ? 1.7 : 0.4);
